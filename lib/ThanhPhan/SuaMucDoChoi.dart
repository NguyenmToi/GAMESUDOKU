...
class _SuaMucDoChoiState extends State<SuaMucDoChoi> {
  ...
  List<List<bool>> oDaThayDoi = List.generate(9, (_) => List.generate(9, (_) => false));
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          Border border = Border(
            top: BorderSide(
              color: row == 0 ? Colors.black : (row % 3 == 0) ? Colors.black : Colors.grey,
              width: 0.7,
            ),
            left: BorderSide(
              color: col == 0 ? Colors.black : (col % 3 == 0) ? Colors.black : Colors.grey,
              width: 0.7,
            ),
            bottom: BorderSide(
              color: row == 8 ? Colors.black : ((row + 1) % 3 == 0) ? Colors.black : Colors.grey,
              width: 0.7,
            ),
            right: BorderSide(
              color: col == 8 ? Colors.black : ((col + 1) % 3 == 0) ? Colors.black : Colors.grey,
              width: 0.7,
            ),
          );
          ...
          return Container(
            ...
            child: Center(
              child: Text(
                BangSudoku[row][col] == 0 ? '' : BangSudoku[row][col].toString(),
                style: TextStyle(
                  fontSize: 20,
